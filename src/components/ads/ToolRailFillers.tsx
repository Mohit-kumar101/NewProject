        ...
        <ul className="mt-4 space-y-2">
          {tools.map((tool) => (
            <li key={tool.slug}>
              ...
              >
                <span className="block text-xs font-semibold leading-snug text-[var(--foreground)] group-hover:text-[var(--accent)]">
                  {tool.title}
                </span>
...
export function ToolRailSpotlight({ tools }: ToolRailSpotlightProps) {
  return (
