    ...
    <div className="space-y-6">
      <div className="grid gap-5 sm:gap-6 lg:grid-cols-2 lg:items-start">
        <aside className="order-1 lg:order-2 lg:sticky lg:top-24">
          <div className="results-card relative z-0 rounded-2xl p-4 sm:p-6">
        ...
        <div className="calc-panel order-2 rounded-2xl p-4 sm:p-6 lg:order-1">
            ...
            {fields.map((input) =>
              input.inputType === "checkbox" ? (
                <label
                  key={input.id}
                  htmlFor={input.id}
                  className="calc-inset flex cursor-pointer items-center justify-between gap-3 rounded-xl px-3 py-3 sm:px-4"
                >
                ...
                <div key={input.id}>
                  <div className="mb-2 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
                    ...
                    <input
                      ...
                      className="calc-inset w-full rounded-lg px-3 py-2 text-right text-sm outline-none focus:border-[var(--accent)] sm:w-28 sm:px-2.5 sm:py-1.5"
                    />
                  </div>
                  <input
                    id={input.id}
